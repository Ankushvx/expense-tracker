  ...
  <nav className="sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-600/50 shadow-lg shadow-gray-900/5 dark:shadow-black/30">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between h-14 sm:h-16">
        ...
        {/* Desktop Navigation Lisks Section */}
        <div className="hidden md:flex items-center space-x-1">
          ...
          >
            ...
            <div
              className=" absolute inset-0 bg-gradient-to-r from-emerald-500/10 to-green-500/10 rounded-xl opacity-0 group-hover:opacity-100 
        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
          ...
          {/* Authentication - Desktop Section */}
          <div className="hidden sm:block">
            <SignedOut>
              <SignInButton>
                <button className="relative overflow-hidden bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 hover:from-emerald-600 hover:via-gray-600 hover:to-teal-600 text-white px-3 sm:px-4 py-2 rounded-lg sm:rounded-xl text-sm sm:text-sm font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale=105 active:scale-95">
                  <div className=" rela z-10 flex items-center gap-1 sm:gap-2">
                    <span>Sign In</span>F
                    <svg
